...
class ExperiencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experience" do
    assert_difference('Experience.count') do
      post experiences_url, params: { experience: { company: @experience.company, description: @experience.description, office: @experience.office } }
    end
  ...
  test "should update experience" do
    patch experience_url(@experience), params: { experience: { company: @experience.company, description: @experience.description, office: @experience.office } }
